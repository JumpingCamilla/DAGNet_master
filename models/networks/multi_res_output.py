...
## implemented by Ying on 01/13/2022,
##input: semantic-guided disparity information (with 20 channels)
## output: disparity with different scales
class MultiResGuidance(MultiRes):
    def __init__(self, dec_chs, out_chs=1):
        super().__init__(dec_chs, out_chs)
