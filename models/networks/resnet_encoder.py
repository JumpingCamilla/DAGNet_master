...
class ResnetEncoder(nn.Module):
    ...
    def __init__(self, num_layers, pretrained, num_input_images=1):
        ...
        if pretrained:
            pretrained_pth = "models.ResNet{}_Weights.IMAGENET1K_V1".format(num_layers)

            self.encoder = RESNETS[num_layers](pretrained)#self.encoder = RESNETS[num_layers](weights=models.ResNet18_Weights.IMAGENET1K_V1)
        else:
