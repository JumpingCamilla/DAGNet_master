...
class ArgumentsBase(object):
    ...
    def _harness_init_system(self):
        ...
        self.ap.add_argument(
            '--sys-num-workers', type=int,default=6, #default=3,
    ...
    def _harness_init_model(self):
        ...
        self.ap.add_argument(
            '--experiment-class', type=str, default='dadepth_test',
            help='A nickname for the experiment folder'
        )

        self.ap.add_argument(
            '--model-name', type=str, default='dadepth_base',
        ...
        self.ap.add_argument(
            '--semantic-guidance', default=False, action='store_true',
            help='Determines whether use semantic information to guide depth estimation'
        )

        self.ap.add_argument(
            '--depth-guidance', default=False, action='store_true',
            help='Determines whether use depth information to guide semantic segmentation'
        )

        self.ap.add_argument(
            '--feature-fusion', default=False, action='store_true',
            help='Determines whether to fuse depth and semantic information'
        )
    ...
    def _training_init_train(self):
        ...
        self.ap.add_argument(
            '--train-num-epochs', type=int, default=40,
        ...
        self.ap.add_argument(
            '--train-print-frequency', type=int, default=5000,
        ...
        self.ap.add_argument(
            '--train-weight-decay', type=float, default=0.1, #0.0
        ...
        ## Ying, 23/05/26, Freq-Depth ablation study
        self.ap.add_argument("--disable_auto_blur",
                                 help="if set, disable Auto-Blur",
                                 default=False, action="store_true")
        self.ap.add_argument("--receptive_field_of_auto_blur",
                                 type=int, default=9)
        self.ap.add_argument("--disable_ambiguity_mask",
                                 help="if set, disable Ambiguity-Masking",
                                 default=False,
                                 action="store_true")
        self.ap.add_argument("--ambiguity_thresh",
                                 type=float,
                                 help="threshold for ambiguous pixels",
                                 default=0.3)
        self.ap.add_argument("--hf_pixel_thresh",
                                 type=float,
                                 help="hf pixel thresh in Auto-Blur",
                                 default=0.2)
        self.ap.add_argument("--hf_area_percent_thresh",
                                 type=int, default=60)
        self.ap.add_argument("--ambiguity_by_negative_exponential",
                                 help='if set, use negative exponential '
                                      'to replace threshold',
                                 default=False, action="store_true")
        self.ap.add_argument("--negative_exponential_coefficient",
...
class TrainingArguments(ArgumentsBase):
    DESCRIPTION = 'DADepth training arguments'
...
class DepthEvaluationArguments(ArgumentsBase):
    DESCRIPTION = 'DADepth Depth Evaluation'
...
class SegmentationEvaluationArguments(ArgumentsBase):
    DESCRIPTION = 'DADepth Segmentation Evaluation'
...
class InferenceEvaluationArguments(ArgumentsBase):
    DESCRIPTION = 'DADepth Segmentation Inference'
